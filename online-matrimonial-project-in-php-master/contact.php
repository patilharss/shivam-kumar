...
<div class="grid_3">
  <div class="container" >
   ...
   <div class="grid_5 animate__animated animate__fadeInDown  animate__delay-1s">
      <p><strong>Praesent vestibulum molestie lacus. Aenean nonummy hendrerit mauris. Phasellus porta. Fusce suscipit varius mi. Cum sociis natoque penatibus et magnis dis parturient. montes, nascetur ridiculus mus. Nulla dui. Fusce feugiat malesuada odio. Morbi nunc odio, gravida at, cursus nec, luctus a, lorem. Maecenas tristique orci ac sem. Duis ultricies pharetra magna. Donec accumsan malesuada orci. Donec sit amet eros. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Mauris fermentum dictum magna. Sed laoreet aliquam leo. Ut tellus dolor, dapibus eget, elementum vel, cursus eleifend, elit.</strong></p>
      <address class="addr row animate__animated animate__fadeInDown  animate__delay-1s">
        <dl class="grid_4">
            <dt>Address :</dt>
            <dd>
