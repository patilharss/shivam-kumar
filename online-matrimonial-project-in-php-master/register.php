  ...
  <div class="container">
   ...
   <div class="services">
	     ...
	     <form action="" method="POST">
		      ...
		      <input type="text" id="edit-name" name="name" value="" size="60" maxlength="60" minlength="4" class="form-text required" required>
		    </div>
		    <div class="form-group">
		      <label for="edit-pass">Password <span class="form-required" title="This field is required.">*</span></label>
		      <input type="password" id="edit-pass" minlength="4" name="pass" size="60" maxlength="128" class="form-text required" required>
		    </div>
		    <div class="form-group">
